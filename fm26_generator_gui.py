...
class App(tk.Tk):
    ...
    def _build_contract_tab_common(self, frm, prefix: str, mode_label: str) -> None:
            ...
            # Generation settings (placed here so you can edit Contract without jumping tabs)
            genf = ttk.LabelFrame(frm, text=f"Generation settings ({mode_label})")
            genf.grid(row=1, column=0, sticky="ew", padx=8, pady=(0, 8))
            for _c in range(6):
                genf.columnconfigure(_c, weight=1)
            ...
            ttk.Label(genf, text="Seed").grid(row=0, column=2, sticky="w", padx=6, pady=6)
            ttk.Entry(genf, textvariable=getattr(self, f"{prefix}_seed"), width=12).grid(row=0, column=3, sticky="w", padx=6, pady=6)

            ttk.Label(genf, text="Base year").grid(row=0, column=4, sticky="w", padx=6, pady=6)
            ttk.Entry(genf, textvariable=getattr(self, f"{prefix}_base_year"), width=10).grid(row=0, column=5, sticky="w", padx=6, pady=6)
            ...
            def _row_combo(parent, r, label, key, values=()):
                ...
                v = tk.StringVar(value="")
                vars_store[f"{key}_var"] = v
                cb = ttk.Combobox(parent, textvariable=v, values=list(values), state="readonly")
            ...
            def _row_contract_club(parent, r):
                ...
                cb = ttk.Combobox(wrap, textvariable=v, state="readonly")
                ...
                filt_cb = ttk.Combobox(wrap, textvariable=filt, values=["Any", "Men", "Women"], state="readonly", width=10)
    ...
    def _build_batch_tab(self) -> None:
        ...
        self.batch_ca_dont_set = tk.BooleanVar(value=True)
        self.batch_pa_dont_set = tk.BooleanVar(value=True)

        # DOB mode
        self.batch_dob_mode = tk.StringVar(value="none")  # age|range|fixed (Age range controls moved to Details tab)
        ...
        self.batch_feet_dont_set = tk.BooleanVar(value=True)
        ...
        self.batch_wage_dont_set = tk.BooleanVar(value=True)
        ...
        self.batch_rep_dont_set = tk.BooleanVar(value=True)
        ...
        self.batch_tv_dont_set = tk.BooleanVar(value=True)
        ...
        self.batch_positions_dont_set = tk.BooleanVar(value=True)
        ...
        self.batch_club_dont_set = tk.BooleanVar(value=True)
...
# Development positions (2..19) - auto-selected by generator for multi-position profiles
    ...
    def _build_single_tab(self) -> None:
        ...
        self.single_dob_mode = tk.StringVar(value="none")  # age|dob
        ...
        self.single_ca_dont_set = tk.BooleanVar(value=True)
        self.single_pa_dont_set = tk.BooleanVar(value=True)
        ...
        self.single_feet_dont_set = tk.BooleanVar(value=True)
        ...
        self.single_wage_dont_set = tk.BooleanVar(value=True)
        ...
        self.single_rep_dont_set = tk.BooleanVar(value=True)
        ...
        self.single_tv_dont_set = tk.BooleanVar(value=True)
        ...
        self.single_positions_dont_set = tk.BooleanVar(value=True)
        ...
        self.single_club_dont_set = tk.BooleanVar(value=True)
...
try:
    ...
    App._ensure_output_visible = _ensure_output_visible
    App._run_async_stream = _run_async_stream
    ...
    pass
# --- end v58 hotfix ---
# =================== end v58 method recovery patch ===================


# Bind contract-tab helper functions patched in as top-level defs to the App class.
try:
    App._get_contract_row = _get_contract_row
    App._apply_contract_tab_generation_overrides = _apply_contract_tab_generation_overrides
except Exception:
    pass
