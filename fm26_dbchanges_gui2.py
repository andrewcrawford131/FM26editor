...
APP_TITLE = "FM26 DBChanges Tools (Library Extractor + Players Generator) — Friendly v15.3 (generator2 build)"

DEFAULT_EXTRACT_SCRIPT = "fm_dbchanges_extract_fixed_v4.py"
DEFAULT_GENERATE_SCRIPT = "fm26_bulk_youth_generator2.py"
...
class App(tk.Tk):
    ...
    def _build_single_tab(self) -> None:
        ...
        # Wage / Reputation / Transfer value
        self.single_wage_mode = tk.StringVar(value="range")  # range|fixed
        ...
        self.single_rep_mode = tk.StringVar(value="range")  # range|fixed
        ...
        self.single_tv_mode = tk.StringVar(value="auto")  # auto|fixed|range
    ...
    def _run_batch_generator(self) -> None:
        ...
        # Wage
        if getattr(self, "batch_wage_mode", tk.StringVar(value="range")).get() == "fixed":
        ...
        # Reputation
        if getattr(self, "batch_rep_mode", tk.StringVar(value="range")).get() == "fixed":
        ...
        # Transfer value
        tv_mode = getattr(self, "batch_tv_mode", tk.StringVar(value="auto")).get().strip() or "auto"
    ...
    def _run_single_generator(self) -> None:
        ...
        # Wage
        if getattr(self, "single_wage_mode", tk.StringVar(value="fixed")).get() == "fixed":
        ...
        # Reputation
        if getattr(self, "single_rep_mode", tk.StringVar(value="range")).get() == "fixed":
        ...
        # Transfer value
        tv_mode = getattr(self, "single_tv_mode", tk.StringVar(value="auto")).get().strip() or "auto"
        extra.extend(["--transfer_mode", tv_mode])
        if tv_mode == "fixed":
